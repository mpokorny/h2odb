...
object Tables {
  ...
  val analytes = Map(
    alkalinity     -> "ALK",
    aluminum       -> "Al",
    aluminumTotal  -> "Al(total)",
    anions         -> "TAn",
    antimony       -> "Sb",
    antimonyTotal  -> "Sb(total)",
    arsenic        -> "As",
    arsenicTotal   -> "As(total)",
    barium         -> "Ba",
    bariumTotal    -> "Ba(total)",
    beryllium      -> "Be",
    berylliumTotal -> "Be(total)",
    bicarbonate    -> "HCO3",
    boron          -> "B",
    boronTotal     -> "B(total)",
    bromide        -> "Br",
    bromtideTotal  -> "Br(total)",
    cadmium        -> "Cd",
    cadmiumTotal   -> "Cd(total)",
    calcium        -> "Ca",
    calciumTotal   -> "Ca(total)",
    carbonate      -> "CO3",
    cations        -> "TCat",
    chloride       -> "Cl",
    chlorideTotal  -> "Cl(total)",
    chromium       -> "Cr",
    chromiumTotal  -> "Cr(total)",
    cobalt         -> "Co",
    cobaltTotal    -> "Co(total)",
    copper         -> "Cu",
    copperTotal    -> "Cu(total)",
    fluoride       -> "F",
    hardness       -> "HRD",
    iron           -> "Fe",
    ironTotal      -> "Fe(total)",
    ...
    leadTotal      -> "Pb(total)"
    lithium        -> "Li",
    lithiumTotal   -> "Li(total)",
    magnesium      -> "Mg",
    magnesiumTotal -> "Mg(total)",
    manganese      -> "Mn",
    manganeseTotal -> "Mn(total)",
    molybdenum     -> "Mo",
    molybdenumTotal-> "Mo(total)",
    nickel         -> "Ni",
    nickelTotal    -> "Ni(total)"
    nitrate        -> "NO3",
    nitrite        -> "NO2",
    phosphate      -> "PO4",
    percentDiff    -> "IONBAL",
    potassium      -> "K",
    potassiumTotal -> "K(total)",
    selenium       -> "Se",
    seleniumTotal  -> "Se(total)",
    siliconDioxide -> "SiO2",
    silicon        -> "Si",
    siliconTotal   -> "Si(total)",
    silver         -> "Ag",
    silverTotal    -> "Ag(total)",
    sodium         -> "Na",
    sodiumTotal    -> "Na(total)",
    conductance    -> "CONDLAB",
    strontium      -> "Sr",
    strontiumTotal -> "Sr(total)",
    sulfate        -> "SO4",
    tds            -> "TDS",
    thallium       -> "Tl",
    thalliumTotal  -> "Tl(total)",
    thorium        -> "Th",
    thoriumTotal   -> "Th(total)",
    tin            -> "Sn",
    tinTotal       -> "Sn(total)",
    titanium       -> "Ti",
    titaniumTotal  -> "Ti(total)",
    uranium        -> "U",
    uraniumTotal   -> "U(total)",
    vanadium       -> "V",
    vanadiumTotal  -> "V(total)",
    zinc           -> "Zn",
    zincTotal      -> "Zn(total)",
    pH             -> "pHL")
